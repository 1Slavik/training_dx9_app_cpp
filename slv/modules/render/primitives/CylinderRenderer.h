...
#include "../IRenderer.h"
#include "mesh_data/CylinderMesh.h"
#include "../Mesh.h"
...
namespace slv
{
	namespace modules
	{
		namespace render
		{
			...
			{
				class CylinderRenderer : public ::slv::modules::render::IRenderer
				{
				public:
					using Vertex = CylinderMesh::Vertex;
					using VertexIndex = CylinderMesh::VertexIndex;
					using Mesh = ::slv::modules::render::Mesh<Vertex, VertexIndex>;
				private:
					const Mesh* m_pMesh;
					const CylinderMesh* m_pCylinderMesh;

					float m_radius, m_height;
					vec3 m_pos, m_dir;
					FillMode m_fillMode;
				public:
					CylinderRenderer(const Mesh*, const CylinderMesh*, float r, float h);
					virtual ~CylinderRenderer();
